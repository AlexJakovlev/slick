...
//         }))
// });
gulp.task('browserSync', gulp.series(scripts, styles, build_html, html, function bb(done) {
    // gulp.task('browserSync', gulp.series(scripts, pug, styles, build_html, html, function (done) {
...
// // gulp.task('comboimages', function (tmp) {
// //     gulp.src(['app/images/*.jpg', 'app/images/*.png'])
// //         //prevent pipe breaking caused by errors from gulp plugins
// //         .pipe(plumber())
...
//     var bpath = 'app/images/svg/';
//     gulp.src([bpath + '*', '!app/images/svg/*.*'])
//         .on('data', function (event) {
//             var name = bpath + paths.parse(event.path).name;
//             var pp = name + '/*.svg';
//             console.log(pp);
//             gulp.src(pp)
//                 .on('data', function (event) {
...
gulp.task('default', gulp.series('browserSync', function (done) {
    //a list of watchers, so it will watch all of the following files waiting for changes
    ...
    gulp.watch('app/html/*.html', build_html);
    gulp.watch('app/*.html', html);
    done();
}));
//this is our deployment task, it will set everything for deployment-ready files
